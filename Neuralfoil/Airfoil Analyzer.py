...
# ============================================================
# === FILE WRITING (XFOIL Results-STYLE POLAR OUTPUT) ================
# ============================================================

def save_polar_file(filename, alphas, CL, CD, Cm=None):
    """Saves aerodynamic data to a text file similar to XFOIL Results polar output."""
    with open(filename, "w") as f:
        f.write("--------------------------------------------------------------\n")
        f.write("  XFOIL Results-like Polar Output (Generated by NeuralFoil)\n")
        f.write("--------------------------------------------------------------\n")
