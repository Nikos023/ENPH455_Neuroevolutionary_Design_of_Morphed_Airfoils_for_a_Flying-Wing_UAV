...
# ================== LOAD GLOBAL MODELS =====================
model_cl = joblib.load(os.path.join(model_dir, "global_cl_gb_2000Re1e6_samples.joblib"))
model_cd = joblib.load(os.path.join(model_dir, "global_cd_gb_2000Re1e6_samples.joblib"))
model_cm = joblib.load(os.path.join(model_dir, "global_cm_gb_2000Re1e6_samples.joblib"))
