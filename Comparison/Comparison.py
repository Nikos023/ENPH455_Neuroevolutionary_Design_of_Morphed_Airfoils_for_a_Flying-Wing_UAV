...
print(f"Loaded {len(alpha_x)} XFOIL Results points | {len(alpha_nf)} NeuralFoil points")

# ============================================================
# === INTERPOLATE NEURALFOIL TO MATCH XFOIL Results ALPHAS ===========
# ============================================================
...
summary = f"""
=== NeuralFoil vs XFOIL Results Error Summary ===
...
# Extract airfoil number from XFOIL Results filename (assuming format 'airfoil_XFOIL_000_ReXXXXXXX.txt')
...
with open(output_error_file, "w") as f:
    f.write("==============================================================\n")
    f.write(" NeuralFoil vs XFOIL Results Comparison Report\n")
    f.write("==============================================================\n\n")
    f.write(summary + "\n")
...
fig.suptitle(f"XFOIL Results vs NeuralFoil Comparison — Airfoil {airfoil_number} (Re={int(Re):.0f})",
...
axs[0, 1].set_ylabel("ΔCl (NF - XFOIL Results)")
...
axs[1, 1].set_ylabel("ΔCd (NF - XFOIL Results)")
...
axs[2, 1].set_ylabel("ΔCm (NF - XFOIL Results)")
